...
#define vsprintf     call._vsprintf
#define sprintf      call._sprintf
#define putc         call._putc
#define printf       call._printf

#define getc         call._getc
#define gets         call._gets

#define vsscanf      call._vsscanf
#define sscanf       call._sscanf
