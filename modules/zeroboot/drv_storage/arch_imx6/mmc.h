...
struct mmc {
	...
	uint tran_speed;
	u8 *ext_csd;
	dma_addr_t ext_csd_phys;
	u8 *data_buf; 
	dma_addr_t data_buf_phys;
	uint *scr;
	dma_addr_t scr_phys;
	uint *switch_status;
	dma_addr_t switch_status_phys;
...
int mmc_read(struct mmc *mmc, u64 src, unsigned char *dst, int size);
...
struct zb_priv_mmc {
	union {
		struct {
			...
			unsigned int scr;
			unsigned int scr_phys;
			unsigned int switch_status;
			unsigned int switch_status_phys;
			unsigned int ext_csd;
			unsigned int ext_csd_phys;
